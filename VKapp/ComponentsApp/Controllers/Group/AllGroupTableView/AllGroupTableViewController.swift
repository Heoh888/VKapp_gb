...
class AllGroupTableViewController: UITableViewController {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        return Group.init().friends.count
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return Group.init().friends[section].count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameGruop.text = allGroup.friends[indexPath.section][indexPath.row]
        cell.imageGroup.image = allGroup.logoImage[indexPath.section][indexPath.row]
        return cell
    }
